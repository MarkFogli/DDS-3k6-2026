...
app.get("/products", async (req, res) => {
    ...
    try {
        const products = await getAllProducts(); // Llamamos a la función para obtener los productos
...
app.post("/products", async (req, res) => {
    ...
    try {
        ...
        if (data) {
            await addProduct(data); // Llamamos a una función para agregar el producto (aún no implementada)
